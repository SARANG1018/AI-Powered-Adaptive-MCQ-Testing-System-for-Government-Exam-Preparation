"""
Django settings for SIH_adaptive_learning project.
...
SECRET_KEY = 'django-insecure-2%-ro+34_%(p+h&!++%1xy(3mlui^g7%9gswk0i*-)v$(%q8w@'
...
ROOT_URLCONF = 'SIH_adaptive_learning.urls'
...
WSGI_APPLICATION = 'SIH_adaptive_learning.wsgi.application'
